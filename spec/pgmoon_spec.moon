...
describe "pgmoon with server", ->
  setup ->
    os.execute GetRedbeanVersion and "../spec/postgres.sh start" or "spec/postgres.sh start"

  teardown ->
    os.execute GetRedbeanVersion and "../spec/postgres.sh stop" or "spec/postgres.sh stop"
